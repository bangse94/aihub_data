'''
    Thist script is used to convert AIHub 136 Night dataset to YOLO format.
    
    version: 1.0
        - AIHub 136 Night dataset
...
def main(source_dir: str, target_dir: str) -> None:
    '''This function is used to convert AIHub 136 Night dataset to YOLO format
